...
class OpenerDevice extends NukiDevice {
      ...
      try {
        ...
        if (value === 1) {
          if (this.progressingAction > 0) {
            ...
            flow.getDeviceTriggerCard('nuki_state_changed_opener').trigger(this, prevArg, {});
  ...
  updateCapabilitiesValue (newState) {
    ...
    if (state != prevState || continuousMode != prevContinuousMode) {
      ...
      flow.getDeviceTriggerCard('nuki_state_changed_opener').trigger(this, { previous_state: prevState, previous_continuous_mode: prevContinuousMode }, {});
    }
  ...
  _restoreStatusBeforeOpening (baseState) {
    ...
    this.setCapabilityValue('nuki_state', nukiState);
    flow.getDeviceTriggerCard('nuki_state_changed_opener').trigger(this, {
